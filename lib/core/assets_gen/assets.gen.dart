...
class $AssetsSvgsGen {
  ...
  SvgGenImage get addIcon => const SvgGenImage('assets/svgs/add_icon.svg');

  /// File path: assets/svgs/adidas_logo.svg
  SvgGenImage get adidasLogo =>
      const SvgGenImage('assets/svgs/adidas_logo.svg');

  /// File path: assets/svgs/convers_logo.svg
  SvgGenImage get conversLogo =>
      const SvgGenImage('assets/svgs/convers_logo.svg');
  ...
  /// File path: assets/svgs/nike_logo.svg
  SvgGenImage get nikeLogo => const SvgGenImage('assets/svgs/nike_logo.svg');
  ...
  SvgGenImage get underArmourLogo =>
      const SvgGenImage('assets/svgs/under_armour_logo.svg');
